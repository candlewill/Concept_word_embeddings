...
1. 发现ANEW中的同义词：
 ...
 1. 对于ANEW中的词汇A、B，如果A出现在B的同义词集合中，**同时**B也出现在A的同义词集合中，则认为A、B是同义词，最终发现ANEW中仅有如下4对同义词：
 ...
 2. 对于ANEW中的词汇A、B，如果A出现在B的同义词集合中，**或者**B出现在A的同义词集合中，则认为A、B是同义词，最终发现ANEW中符合这种规律的词汇较多，详见[data/synsets/ANEW_synonym_pairs.md](./data/synsets/ANEW_synonym_pairs.md)，截取一部分如下：
